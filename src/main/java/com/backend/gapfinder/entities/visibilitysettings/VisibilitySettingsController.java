...
public class VisibilitySettingsController {
    ...
    public VisibilitySettingsBasicDTO createVisibilitySettings(
        ...
        VisibilitySettingsEntity entity = modelMapper.map(dto, VisibilitySettingsEntity.class);
        VisibilitySettingsEntity created = visibilitySettingsService.create(userId, entity);
    ...
    public VisibilitySettingsBasicDTO getByUser(@PathVariable Long userId) {
        VisibilitySettingsEntity entity = visibilitySettingsService.getByUser(userId);
    ...
    public VisibilitySettingsBasicDTO updateVisibilitySettings(
        ...
        VisibilitySettingsEntity entity = modelMapper.map(dto, VisibilitySettingsEntity.class);
        VisibilitySettingsEntity updated = visibilitySettingsService.update(userId, entity);
