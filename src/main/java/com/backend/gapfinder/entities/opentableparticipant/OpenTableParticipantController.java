...
public class OpenTableParticipantController {
    ...
    public List<OpenTableParticipantBasicDTO> getByOpenTable(@PathVariable Long openTableId) {
        List<OpenTableParticipantEntity> participants = participantService.getByOpenTable(openTableId);
    ...
    public OpenTableParticipantBasicDTO findParticipant(
        ...
        Optional<OpenTableParticipantEntity> participant = participantService.findParticipant(openTableId, userId);
