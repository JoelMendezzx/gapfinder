...
public class InterestService {
    ...
    @Transactional
    public List<InterestEntity> getAll() {
    ...
    @Transactional
    public InterestEntity create(InterestEntity interest) {
        log.info("Inicia proceso de creación del interés");

        validateInterestData(interest);

        Optional<InterestEntity> existente = interestRepository.findByName(interest.getName());
    ...
    @Transactional
    public InterestEntity update(Long id, InterestEntity interest) {
        log.info("Inicia proceso de actualización del interés con id = {}", id);

        InterestEntity existente = getById(id);
        validateInterestData(interest);
    ...
    private void validateInterestData(InterestEntity interest) {
