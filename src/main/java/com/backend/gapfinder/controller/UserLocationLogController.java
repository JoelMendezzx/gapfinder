...
import com.backend.gapfinder.dto.response.BuildingTimeDTO;
import com.backend.gapfinder.dto.response.UserLocationLogBasicDTO;
import com.backend.gapfinder.model.BuildingModel;
import com.backend.gapfinder.model.UserLocationLogModel;
import com.backend.gapfinder.service.UserLocationLogService;
...
public class UserLocationLogController {
    ...
    public UserLocationLogBasicDTO create(
        ...
        UserLocationLogModel checkpoint =
    ...
    public List<UserLocationLogBasicDTO> getAllByGap(
        ...
        List<UserLocationLogModel> checkpoints =
    ...
    public List<BuildingTimeDTO> getTimePerBuilding(
        ...
        Map<BuildingModel, Integer> tiempoPorBuilding =
    ...
    public BuildingBasicDTO getFavoriteBuilding(
        ...
        Optional<BuildingModel> favorite =
    ...
    public BuildingBasicDTO getTopBuildingForGap(
        ...
        Optional<BuildingModel> topBuilding =
                userLocationLogService
